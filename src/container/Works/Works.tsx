...
const Works = () => {
  ...
  const [works, setWorks] = useState<WorksModel[]>([]);
  const [filterWork, setFilterWork] = useState<WorksModel[]>([]);
  ...
  return (
    <>
      <h2 className="head-text">
        Site <span>Projects</span> I Made When Learning And <span>Working</span>
      </h2>

      <div className="app__work-filter">
        {["UI/UX", "Web App", "Vanilla Javascript", "ReactJS", "All"].map(
          (item, index) => (
            <div
              key={index}
        ...
        {filterWork?.map((work, index) => (
          <div className="app__work-item app__flex" key={index}>
            <div className="app__work-img app__flex">
              <img
                src={String(urlFor(work.imgUrl.asset._ref))}
            ...
            <div className="app__work-content app__flex">
              <h4 className="bold__text">{work?.title}</h4>
